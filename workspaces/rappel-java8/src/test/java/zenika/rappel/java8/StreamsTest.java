...
public class StreamsTest
{
    ...
    @Test public void filter_map_reduce_DEPRECATED() {
        ...
        // -plus verbeux
        // -une classe anonyme par prédicat
    ...
    @Test public void simpleCollect_contextualOrder() {
        ...
        //On peut indenter, ça reste une seule EXPRESSION,
        // et non une suite de STATEMENTS comme ds l'anti-pattern escalier
        //Donc pas de pb, car bcp plus facile à se représenter
        //Si ça vous gêne au debut, vous pouvez séparer les expressions,
